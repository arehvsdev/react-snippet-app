...
export const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div
      ...
      className="fixed bottom-24 right-3 sm:right-5 z-50 w-[calc(100vw-24px)] sm:w-[400px] h-[70vh] sm:h-[580px] max-h-[600px] bg-gray-900 border border-gray-700/90 rounded-2xl shadow-2xl shadow-black/60 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200"
    >
      {/* 1. Fixed Header */}
