...
export const ChatLauncher: React.FC<ChatLauncherProps> = ({ isOpen, onToggle }) => {
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-2xl shadow-blue-600/35 ring-4 ring-blue-500/15 flex items-center justify-center transition-all duration-200 hover:scale-108 active:scale-95 cursor-pointer"
    >
