...
export function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1e2939] text-white">
      <main className="flex-grow grid md:grid-cols-2">
        {/* Left Side - Branding (uses same gradient background as the login page) */}
        <section className="login-left-panel hidden md:flex items-center justify-center p-10 text-white">
          <div className="relative z-10 max-w-md">
            <div className="flex items-center gap-3 mb-8">
              <div className="bg-white/10 p-3 rounded-2xl border border-white/20">
                <Code2 className="w-10 h-10 text-white" />
              </div>
              <h1 className="text-3xl font-extrabold text-white tracking-tight">CodeSnippets</h1>
            </div>
            ...
            <div className="space-y-4 w-full">
              <div className="flex items-center gap-4">
                ...
                <span className="text-white/90 font-medium">Save and organize your favorite snippets</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-white/10 p-2 rounded-xl border border-white/10">
                  <Globe className="w-5 h-5 text-white" />
                </div>
                <span className="text-white/90 font-medium">Share publicly with the world or keep them private</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-white/10 p-2 rounded-xl border border-white/10">
                  <Lock className="w-5 h-5 text-white" />
                </div>
                <span className="text-white/90 font-medium">Secure storage, accessible from anywhere</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="flex items-center justify-center p-6 bg-[#1e2939]">
          <div className="w-full max-w-md bg-[#2d2f31] border border-white/10 p-8 rounded-2xl shadow-xl">
            ...
            {/* Toggle Tabs */}
            <div className="flex gap-2 mb-8 bg-[#141d2b] p-1 rounded-lg border border-white/5">
              <button
